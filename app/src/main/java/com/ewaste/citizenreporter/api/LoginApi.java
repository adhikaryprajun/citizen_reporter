...
import com.ewaste.citizenreporter.LoginActivity;
...
public class LoginApi {
    ...
    void handleLoginApiResponse() {
        if(loginApiResponse.getResponse().isValid()) {
            ...
            intent.putExtra(UserActivity.KEY_BUNDLE_SESSION, loginApiResponse.getSession());
//            intent.putExtra(UserActivity.KEY_BUNDLE_UPLOAD_TYPE, "0"); // LOADING MY ACTIVE UPLOADS
